...
// Get the modal and buttons for ingredient
const addIngredientModal = document.getElementById("add-ingredient-model");
const addIngredientBtn = document.getElementById("add-ingredient-button");
const cancelAddIngredientBtn = document.getElementById("cancel-button");
